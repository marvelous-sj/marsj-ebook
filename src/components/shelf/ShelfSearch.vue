<template>
  <div class="shelf-search-wrapper" :class="{'search-top': ifInputClicked,'hide-shadow':isHideShadow}">
    <div class="shelf-search" :class="{'do-search': ifInputClicked}">
      <div class="search-wrapper">
        ...
        <div class="icon-clear-wrapper" v-show="searchText.length>0" @click="handleClear">
          <span class="icon-close-circle-fill"></span>
        </div>
      </div>
      <div class="icon-locale-wrapper" v-if="!ifInputClicked" @click="handleChangeLang">
...
<script>
  ...
  export default {
    ...
    watch: {
      offsetY (offsetY) {
        this.isHideShadow = !(offsetY > 0 && this.ifInputClicked)
      }
    },
    data () {
      return {
