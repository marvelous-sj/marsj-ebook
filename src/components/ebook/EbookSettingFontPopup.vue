  ...
  <transition name="popup-slide-up">
    <div class="ebook-popup-list" v-show="fontFamilyVisible">
      <div class="ebook-popup-title">
        ...
        <span class="ebook-popup-title-test">{{$t('book.selectFont')}}</span>
      </div>
      <div class="ebook-popup-list-wrapper">
        <div class="ebook-popup-item" v-for="(item, index) in fontFamilyList" :key="index"
             @click="setDefaultFont(item.font)">
          <div class="ebook-popup-item-test" :class="{'selected':isSelected(item)}">{{item.font}}</div>
